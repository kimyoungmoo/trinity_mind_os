...
async function main() {
    ...
    const phases: Phase[] = ssot['trinity.phase.json'].phases;
    const xTypes: ArtifactType[] = colorMap.axes.x_artifact_types;
    const yLanes: Lane[] = colorMap.axes.y_workstream_lanes;
